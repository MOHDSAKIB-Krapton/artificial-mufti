...
export const createMetaData = ({
  ...
  image = "https://artificial-mufti.vercel.app/assets/custom_icons/logo-full.png",
} = {}) => {
  return {
    metadataBase: new URL("https://artificial-mufti.vercel.app"),
    title,
    description,
    keywords,
    url,
    ...
    twitter: {
      ...
      site: "https://artificial-mufti.vercel.app",
      title,
      description,
      images: [image],
    },
